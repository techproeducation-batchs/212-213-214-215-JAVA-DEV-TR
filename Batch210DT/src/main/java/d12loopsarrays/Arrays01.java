    ...
    public static void main(String[] args) {
        /*
            ...
            3)Array olusturmak icin
                    i)Data Tipi ii)Data sayisi (Dizi boyutu için belirtilebilecek maksimum değer, Integer.MAX_VALUE (yaklaşık 2 milyar) olarak sınırlıdır) soylenmelidir.
        ...
        */
        ...
        //@4617c264 seklinde bellekteki adresi yazar
        ...
        for (int i = 0; i < cities.length; i++) { //Array'lerde length method degildir.Field'dir
